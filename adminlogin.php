...
#formContent {
  ...
  position: relative;
  padding: 0px;
  -webkit-box-shadow: 0 30px 60px 0 rgba(0,0,0,0. padding: 0px;
  -webkit-box-shadow: 0 30px 60px 0 rgba(0,0,0,03);
...
h2.active {
  ...
  -webkit-box-shadow: 0 30px 60px 0 rgba(0,0,0,0.3);
   box-shadow: 0 30px 60px 0 rgba(0,0,0,0.3);
  text-align: center;0px 60px 0 rgba(0,0,0,0.3);
  text-align: center;
}
#formFooter {
  background-color: #f6f6f6;
...
* {
  ...
  <div id="formContent">
    ...
    <div class="fadeIn first">
      <img src="images/webmail.webp" id="icon" alt="User Icon" />
    </div>
