...
<html lang="en">
  <head>
    <title>Wirmon &mdash; About Us</title>
    <meta charset="utf-8">
...
<div class="site-wrap">
    ...
    <section class="py-5 bg-image overlay-primary fixed overlay" id="next-section" style="background-image: url('images/hero_11.jpg');">
      <div class="container">
    ...
    <section class="site-section">
      <div class="container">
        ...
        <div class="row align-items-center block__69944">
          ...
          <div class="col-md-6">
            <h3>Reenu Chaurasiya</h3>
            <p class="text-muted">VP Human Resource</p>
